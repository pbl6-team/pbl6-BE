...
namespace PBL6.Application.Contract.Workspaces
{
    public interface IWorkspaceService
    {
        ...
        Task<PagedResult<AdminWorkspaceDto>> GetAllForAdminAsync(int pageSize, int pageNumber);
        Task<IEnumerable<AdminWorkspaceDto>> SearchForAdminAsync(short searchType, string searchValue, int numberOfResults);
