...
namespace PBL6.Domain.Data.Users
{
    public interface IMessageRepository : IRepository<Message>
    {
        ...
        Task<IEnumerable<Message>> GetMessagesOfChannelAsync(Guid currentUserId, Guid channelId, Guid? parentId, DateTimeOffset timeCursor, int count, bool isBefore = true);
        Task<IEnumerable<Message>> GetMessagesOfUserAsync(Guid currentUserId, Guid toUserId, Guid? parentId, DateTimeOffset timeCursor, int count, bool isBefore = true);
        ...
        Task<int> CountUnreadMessage(Guid currentUserId);
    }
}